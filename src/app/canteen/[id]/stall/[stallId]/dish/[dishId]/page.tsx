...
import { getDishById, getStallById, getCanteenById, Review, getCanteenReviews, getCanteenRating } from "@/lib/supabase";
...
export default function DishDetailPage({ params }: DishDetailPageProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const [dishData, stallData, canteenData, reviewsData, ratingData] = await Promise.all([
          getDishById(params.dishId),
        ...
        if (!dishData || !stallData || !canteenData) {
          notFound();
        }
    ...
    fetchData();
  }, [params.id, params.stallId, params.dishId]);
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href={`/canteen/${params.id}/stall/${params.stallId}`}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600 mb-4">所属档口：{stall.name} | 所属食堂：{canteen.name}</p>
